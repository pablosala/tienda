...
class Config:
    ...
    TPV_URL = os.getenv('TPV_URL', 'https://sis-t.redsys.es:25443/sis/realizarPago')  # URL de pruebas correcta
    TPV_MERCHANT_CODE = os.getenv('TPV_MERCHANT_CODE', '175780451')
    TPV_TERMINAL = os.getenv('TPV_TERMINAL', '1')
    TPV_SECRET_KEY = os.getenv('TPV_SECRET_KEY', 'sq7HjrUOBfKmC576ILgskD5srU870gJ7')
